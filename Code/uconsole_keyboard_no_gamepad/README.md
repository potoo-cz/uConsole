...
7. In the Arduino IDE, open the file `/uConsole/Code/uconsole_keyboard_no_gamepad/uconsole_keyboard_no_gamepad.ino`. It will open many tabs in a new window.
...
12. The binary file will appear near your source code. Check the directory `/uConsole/Code/uconsole_keyboard_no_gamepad/build/stm32duino.STM32F1.genericSTM32F103R/`
13. You should find the file `uconsole_keyboard_no_gamepad.ino.bin`
